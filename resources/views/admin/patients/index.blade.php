                        ...
                        <tr class="hover:bg-surface transition-colors">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <button onclick="deletePatient({{ $patient->id }})" class="w-8 h-8 rounded-lg hover:bg-red-50 flex items-center justify-center transition-colors" title="Delete">
...
async function deletePatient(id) {
    confirmAction('Are you sure you want to delete this patient?', async () => {
        try {
            const response = await fetch(`/admin/patients/${id}`, {
                method: 'DELETE',
                headers: {
