                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-3 mt-1">
                                ...
                                <x-badge variant="{{ $notification->status === 'unread' ? 'primary' : 'default' }}">{{ $notification->type_label }}</x-badge>
                            </div>
                        </div>
                        <div class="flex items-center gap-1">
                            ...
                            @endif
                            <button onclick="event.stopPropagation(); archiveNotification({{ $notification->id }})" class="w-8 h-8 rounded-lg hover:bg-gray-100 flex items-center justify-center transition-colors" title="Archive">
                                <svg class="w-4 h-4 text-text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/></svg>
                            </button>
                        </div>
                    </div>
                </div>
