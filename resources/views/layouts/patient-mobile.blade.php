...
<body class="h-full bg-surface">
    ...
    <div class="min-h-full pb-20">
        <header class="sticky top-0 z-40 bg-[#0d9488] text-white">
            <div class="flex items-center justify-between h-14 px-4">
                ...
                <h1 class="text-lg font-semibold">@yield('page-title', 'Lakeshore Clinic')</h1>
                <a href="{{ route('patient.profile') }}" class="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
    ...
    <nav class="mobile-bottom-nav">
        <div class="flex items-center justify-around h-16">
            <a href="{{ route('patient.dashboard') }}" class="flex flex-col items-center gap-1 py-2 px-3 {{ request()->routeIs('patient.dashboard') ? 'text-[#0d9488]' : 'text-gray-400' }}">
            ...
            <a href="{{ route('patient.book-appointment') }}" class="flex flex-col items-center gap-1 py-2 px-3 {{ request()->routeIs('patient.book-appointment*') ? 'text-[#0d9488]' : 'text-gray-400' }}">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                <span class="text-xs">Book</span>
            </a>
            <a href="{{ route('patient.my-appointments') }}" class="flex flex-col items-center gap-1 py-2 px-3 {{ request()->routeIs('patient.my-appointments') ? 'text-[#0d9488]' : 'text-gray-400' }}">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                <span class="text-xs">Appointments</span>
            </a>
            <a href="{{ route('patient.notifications') }}" class="flex flex-col items-center gap-1 py-2 px-3 {{ request()->routeIs('patient.notifications*') ? 'text-[#0d9488]' : 'text-gray-400' }}">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                <span class="text-xs">Alerts</span>
            </a>
            <a href="{{ route('patient.profile') }}" class="flex flex-col items-center gap-1 py-2 px-3 {{ request()->routeIs('patient.profile*') ? 'text-[#0d9488]' : 'text-gray-400' }}">
